...
const memberPathMap: Record<string, string> = {
  ...
  jungwoo: '<path d="M6.1 7.6 4.3 5.6 4.9 8.6"/><path d="M13.9 7.6l1.8-2 .6 3"/><path d="M5.1 12.6c0-2.7 2.1-4.6 4.9-4.6s4.9 1.9 4.9 4.6"/><circle cx="8.2" cy="10.8" r=".7"/><circle cx="11.8" cy="10.8" r=".7"/><ellipse cx="10" cy="12.3" rx="1" ry=".7"/>',
...
const candyPaths = '<path d="M5.6 8.8 3.2 10l2.4 1.2"/><path d="M14.4 8.8 16.8 10l-2.4 1.2"/><rect x="5.2" y="6.4" width="9.6" height="7.2" rx="2.8"/><path d="M7.7 8.2c1.5-1 3.1-1.2 4.8-.4"/>';
...
export function CandyGlyph({ className, strokeWidth }: GlyphProps) {
  return buildSvg(candyPaths, className, strokeWidth);
}
...
export function candyGlyphSvgString(strokeColor: string): string {
  return `<svg viewBox="0 0 20 20" fill="none" stroke="${strokeColor}" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${candyPaths}</svg>`;
}
